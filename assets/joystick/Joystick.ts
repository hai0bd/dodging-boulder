import { _decorator, EventTarget, Component, Node, Enum, UIOpacity, UITransform, EventTouch, Vec3, Vec2, Size, CCInteger, input, Input } from "cc";
...
export class Joystick extends Component {
  @property({ type: Node, displayName: "Dot", })
  dot: Node | null = null;

  @property({ type: Node, displayName: "Ring", })
  ring: Node | null = null;

  @property({ type: Enum(JoystickType), displayName: "Touch Type", })
  joystickType = JoystickType.FOLLOW;

  @property({ type: Enum(DirectionType), displayName: "Direction Type", })
  ...
  @property({ type: CCInteger, displayName: "Ring Radius", })
  radius = 50;
